...
* Create the Category (Lauren)
* Subcategory DataFrames (Steve)
* Create the Campaign DataFrame (Emily)
* Create the Contacts DataFrame (Ruchi)
* Create the Crowdfunding Database (Nick)
* ReadME (Tye)
...
1. Inspect the four CSV files, and then sketch an ERD of the tables. There are ERD tools in PgAdmin or [QuickDBD](http://www.quickdatabasediagrams.com).
...
* The database has the appropriate primary and foreign keys and relationships (5 points)su
